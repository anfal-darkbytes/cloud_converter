...
def home(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            request.session["uploaded_file_content"] = uploaded_file.read()
...
def convert(request, from_ext, to_ext):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # use previously uploaded file if no new file
            ...
            output_file = convert_file(file_content, file_name, selected_target)
